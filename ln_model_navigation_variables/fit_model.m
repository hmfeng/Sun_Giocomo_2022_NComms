function [testFit,trainFit,param_mean] = fit_model(...
    A,dt,spiketrain,filter,modelType,numFolds,numPos,numHD,numSpd,method,lambda)
...
for k = 1:numFolds
    ...
    switch method
        case('fminunc')
            ...
            [param] = fminunc(@(param) ln_poisson_model(param,data,modelType,numPos,numHD,numSpd),init_param,opts);
        case('glmnet')
